                ...
                <div class="col-4">
                    <div class="text-center">
                        ...
                        <div class="vstack gap-3 mb-4">
                            <input class="form-control py-3 px-3 w-100 bg-transparent" type="text" placeholder="Username" aria-label="default input example">
                        ...
                        <div>
                            <button class="btn background-primary w-100 border text-light py-3 border-0 fw-medium">Sign up</button>
                        </div>
